...
# 🎓 İlkokul Öğrencilerine Yönelik Programlama Temelleri Anket Uygulaması

Bu proje, ilkokul öğrencilerinin **Programlama Temelleri eğitimi öncesi ve sonrası** bilgi düzeylerini ölçmek için geliştirilmiş interaktif bir web uygulamasıdır.

Tüm anket verileri **LocalStorage** üzerinde saklanır ve öğrenciler sayfayı kapatsa bile bilgiler silinmez.
